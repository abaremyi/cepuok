...
-- Dumping data for table cep_uokdb.budget_activities: ~20 rows (approximately)
...
-- Dumping data for table cep_uokdb.credential_wallet_audit: ~0 rows (approximately)
...
-- Dumping data for table cep_uokdb.disbursements: ~0 rows (approximately)
...
-- Dumping data for table cep_uokdb.finance_revenue: ~0 rows (approximately)
REPLACE INTO `finance_revenue` (`id`, `cep_session`, `revenue_type`, `amount`, `description`, `revenue_date`, `reference_no`, `recorded_by`, `created_at`, `updated_at`) VALUES
	(4, 'day', 'tithe', 35000.00, 'Divin Yohereje icyacumi', '2026-03-05', '', 3, '2026-03-08 20:31:59', '2026-03-08 20:31:59'),
	(5, 'day', 'offering', 2300.00, 'Amaturo yo muri English Service', '2026-03-04', '', 3, '2026-03-08 20:32:35', '2026-03-08 20:33:02');
...
-- Dumping data for table cep_uokdb.fund_requests: ~0 rows (approximately)
...
-- Dumping data for table cep_uokdb.fund_request_comments: ~0 rows (approximately)
...
-- Dumping data for table cep_uokdb.indicator_pools: ~6 rows (approximately)
...
-- Dumping data for table cep_uokdb.members: ~6 rows (approximately)
REPLACE INTO `members` (`id`, `user_id`, `membership_type_id`, `membership_number`, `firstname`, `lastname`, `email`, `phone`, `gender`, `date_of_birth`, `address`, `year_joined_cep`, `cep_session`, `faculty`, `program`, `academic_year`, `church_name`, `family_id`, `other_church_name`, `is_born_again`, `is_baptized`, `profile_photo`, `bio`, `status`, `approved_by`, `approved_at`, `created_at`, `updated_at`, `last_activity`) VALUES
	...
	(14, NULL, 2, 'CEP-D-2026-0014', 'ITEKA', 'Evras', 'evrasiteka@gmail.com', '+17125249287', 'Male', '1996-12-05', 'United States', '2020', 'day', 'Information Technology', 'Bsc in IT', 'Year 3', 'ADEPR Kimihurura International Service', NULL, NULL, 'Yes', 'Yes', 'members/69b3c55a55728_1773389146.jpg', 'Enthusiastic Leader and creativity on all he do.', 'pending', NULL, NULL, '2026-03-13 08:05:46', '2026-03-13 08:05:46', NULL);
...
-- Dumping data for table cep_uokdb.membership_applications: ~6 rows (approximately)
REPLACE INTO `membership_applications` (`id`, `member_id`, `application_type`, `status`, `submission_date`, `review_date`, `reviewed_by`, `reviewer_notes`, `rejection_reason`) VALUES
	...
	(10, 14, 'new', 'submitted', '2026-03-13 08:05:46', NULL, NULL, NULL, NULL);
...
-- Dumping data for table cep_uokdb.member_activities: ~5 rows (approximately)
...
-- Dumping data for table cep_uokdb.member_talents: ~53 rows (approximately)
...
-- Dumping data for table cep_uokdb.roles: ~11 rows (approximately)
...
-- Dumping data for table cep_uokdb.role_permissions: ~216 rows (approximately)
REPLACE INTO `role_permissions` (`id`, `role_id`, `permission_id`, `created_at`) VALUES
	...
	(750, 2, 91, '2026-03-08 17:11:13'),
	(751, 2, 1, '2026-03-08 17:11:13'),
	(752, 2, 89, '2026-03-08 17:11:13'),
	(753, 2, 90, '2026-03-08 17:11:13'),
	(754, 2, 88, '2026-03-08 17:11:13'),
	(755, 2, 37, '2026-03-08 17:11:13'),
	(756, 2, 39, '2026-03-08 17:11:13'),
	(757, 2, 38, '2026-03-08 17:11:13'),
	(758, 2, 36, '2026-03-08 17:11:13'),
	(759, 2, 75, '2026-03-08 17:11:13'),
	(760, 2, 72, '2026-03-08 17:11:13'),
	(761, 2, 73, '2026-03-08 17:11:13'),
	(762, 2, 71, '2026-03-08 17:11:13'),
	(763, 2, 85, '2026-03-08 17:11:13'),
	(764, 2, 86, '2026-03-08 17:11:13'),
	(765, 2, 84, '2026-03-08 17:11:13'),
	(766, 2, 83, '2026-03-08 17:11:13'),
	(767, 2, 107, '2026-03-08 17:11:13'),
	(768, 2, 82, '2026-03-08 17:11:13'),
	(769, 2, 87, '2026-03-08 17:11:13'),
	(770, 2, 81, '2026-03-08 17:11:13'),
	(771, 2, 30, '2026-03-08 17:11:13'),
	(772, 2, 28, '2026-03-08 17:11:13'),
	(773, 2, 100, '2026-03-08 17:11:13'),
	(774, 2, 99, '2026-03-08 17:11:13'),
	(775, 2, 45, '2026-03-08 17:11:13'),
	(776, 2, 44, '2026-03-08 17:11:13'),
	(777, 2, 18, '2026-03-08 17:11:13'),
	(778, 2, 15, '2026-03-08 17:11:13'),
	(779, 2, 17, '2026-03-08 17:11:13'),
	(780, 2, 16, '2026-03-08 17:11:13'),
	(781, 2, 19, '2026-03-08 17:11:13'),
	(782, 2, 21, '2026-03-08 17:11:13'),
	(783, 2, 22, '2026-03-08 17:11:13'),
	(784, 2, 20, '2026-03-08 17:11:13'),
	(785, 2, 14, '2026-03-08 17:11:13'),
	(786, 2, 53, '2026-03-08 17:11:13'),
	(787, 2, 52, '2026-03-08 17:11:13'),
	(788, 2, 51, '2026-03-08 17:11:13'),
	(789, 2, 24, '2026-03-08 17:11:13'),
	(790, 2, 25, '2026-03-08 17:11:13'),
	(791, 2, 27, '2026-03-08 17:11:13'),
	(792, 2, 23, '2026-03-08 17:11:13'),
	(793, 2, 41, '2026-03-08 17:11:13'),
	(794, 2, 42, '2026-03-08 17:11:13'),
	(795, 2, 40, '2026-03-08 17:11:13'),
	(796, 2, 96, '2026-03-08 17:11:13'),
	(797, 2, 97, '2026-03-08 17:11:13'),
	(798, 2, 98, '2026-03-08 17:11:13'),
	(799, 2, 95, '2026-03-08 17:11:13'),
	(800, 2, 58, '2026-03-08 17:11:13'),
	(801, 2, 57, '2026-03-08 17:11:13'),
	(802, 2, 56, '2026-03-08 17:11:13'),
	(803, 2, 13, '2026-03-08 17:11:13'),
	(804, 2, 10, '2026-03-08 17:11:13'),
	(805, 2, 11, '2026-03-08 17:11:13'),
	(806, 2, 9, '2026-03-08 17:11:13'),
	(807, 2, 80, '2026-03-08 17:11:13'),
	(808, 2, 77, '2026-03-08 17:11:13'),
	(809, 2, 79, '2026-03-08 17:11:13'),
	(810, 2, 78, '2026-03-08 17:11:13'),
	(811, 2, 76, '2026-03-08 17:11:13'),
	(812, 2, 50, '2026-03-08 17:11:13'),
	(813, 2, 47, '2026-03-08 17:11:13'),
	(814, 2, 48, '2026-03-08 17:11:13'),
	(815, 2, 46, '2026-03-08 17:11:13'),
	(816, 2, 7, '2026-03-08 17:11:13'),
	(817, 2, 4, '2026-03-08 17:11:13'),
	(818, 2, 5, '2026-03-08 17:11:13'),
	(819, 2, 8, '2026-03-08 17:11:13'),
	(820, 2, 3, '2026-03-08 17:11:13'),
	(821, 2, 35, '2026-03-08 17:11:13'),
	(822, 2, 34, '2026-03-08 17:11:13'),
	(823, 2, 32, '2026-03-08 17:11:13'),
	(824, 2, 101, '2026-03-08 17:11:13');
...
REPLACE INTO `users` (`id`, `role_id`, `member_id`, `firstname`, `lastname`, `username`, `email`, `phone`, `password`, `photo`, `bio`, `email_verified`, `email_verification_token`, `email_verification_expires`, `reset_token`, `reset_expiry`, `last_login`, `login_attempts`, `locked_until`, `status`, `is_adepr_member`, `can_manage_website`, `created_by`, `created_at`, `updated_at`, `last_activity`) VALUES
	(1, 1, NULL, 'Super', 'Admin', 'admin', 'admin@cepuok.com', '+250788000000', '$2y$10$cTKQFPz493I5.QQkU1MwzOW.YLOdQKqnHbWzpsnO13eI54jLUnCt6', NULL, NULL, 1, NULL, NULL, NULL, NULL, '2026-03-13 15:12:12', 0, NULL, 'active', 1, 1, NULL, '2026-02-13 15:14:23', '2026-03-13 15:12:12', NULL),
	...
	(3, 6, 6, 'MUKASHEMA', 'Alice', 'mukashema.alice', 'alicemukashema@gmail.com', '0 787 962 735', '$2y$10$od7IhT1Z89vfkm5T8bzUhepdlGyBA4BGmXDauohyh3HDiRFi6OaJ2', 'users/69a0aef3dab68_1772138227.png', 'Courageous enough', 0, NULL, NULL, NULL, NULL, '2026-03-10 21:07:32', 0, NULL, 'active', 1, 0, 1, '2026-02-26 20:37:08', '2026-03-10 21:07:32', NULL),
	(5, 2, 7, 'NTAGAWA', 'David', 'ntagawa.david', 'david.ntagawa@gmail.com', '0791619272', '$2y$10$od7IhT1Z89vfkm5T8bzUhepdlGyBA4BGmXDauohyh3HDiRFi6OaJ2', 'users/69a3d927778da_1772345639.png', '', 0, NULL, NULL, NULL, NULL, '2026-03-13 15:19:06', 0, NULL, 'active', 1, 0, 1, '2026-03-01 06:13:59', '2026-03-13 15:19:06', NULL);
...
-- Dumping data for table cep_uokdb.user_activity_log: ~4 rows (approximately)
