<head>
    ...
    <link href="<?= img_url('logo-only.png') ?>" rel="icon">
    <!--Title-->
    <title>CEP University of Kigali</title>
    <!-- CSS -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?= css_url('bootstrap.min.css') ?>">

    <!-- Simple Line Icons -->
    <link rel="stylesheet" href="<?= css_url('simple-line-icons.min.css') ?>">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="<?= css_url('themify-icons.css') ?>">
    <!-- Owl Slider -->
    ...
    <!-- Revolution Slider -->
    <link rel="stylesheet" type="text/css" href="<?= rs_fonts_url('pe-icon-7-stroke/css/pe-icon-7-stroke.css') ?>">
    <!-- REVOLUTION STYLE SHEETS -->
    <link rel="stylesheet" type="text/css" href="<?= rs_css_url('settings.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= rs_css_url('main-slider/rs6.css') ?>">
    <!-- Color Panel -->
    <link href="<?= css_url('color_panel.css') ?>" rel="stylesheet" type="text/css" />
    <!-- Color Panel -->
    <link href="<?= css_url('color_panel.css') ?>" rel="stylesheet" type="text/css" />
